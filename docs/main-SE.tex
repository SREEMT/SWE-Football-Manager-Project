...
\begin{itemize}
    \item Due to my background, I am not sure I would be able to properly implement the live chat feature on time because I am not so proficient in ruby 
    \item The app needs to support users creating accounts, joining leagues, forming teams, and possibly editing player information. I'm not completely certain how complex this logic will become or the best database structure for it
    \item app can easily become very large. I’m unsure how much functionality is realistic for a single-semester project. I’d like feedback on what features are required for a complete software engineering project compared to what features can be considered optional stretch goals.
    \item Due to time conflicts and workload of other classes I hope that it would not affect the meet up time with my partners as well as the effort I can put into this project
\end{itemize}
...
\vspace{0.3cm}
\noindent \textit{Jordan: I believe we learned a lot from the project, and that the project itself sets us prepared for our capstones. Apart from the teamwork lessons, I believe with the different expereiences, there were moments of teaching each other and sharing our own experiences, creating team cohesion. I learned a lot from all three, from setting up a project with Alberto, working with Ose on the backend, and deciding how the frontend should be with Justin. A personal weakness was communication, admitedly, but it was an issue we learned to resolve, as we lacked communicating at first, but slowly began to connect and manage to build solid teamwork. Despite some miscommunication, we still managed to push out what was needed.}

\vspace{0.3cm}
\noindent \textit{Ose: I would say that it was fun working on a team project. The benefits for me was that it gave me more experience in web programming as well as exposing me to a new programming language(Ruby), I also got the experience of what it was like to work with a client, which gave me a better understanding of real-world communication and project expectations. One of my strengths in working on this project was that when I had some issues, I sought for help from my team member who was more experienced in the programming language than me. My weakness was Time management and something I believe I should do better in. I feel I would have gone further and made a better impact for my team if I had found a way to allocate more time to working on the project. I hope going on form here I can do better to improve my time management skills so I can perform better and make more meaningful contributions in future projects}
