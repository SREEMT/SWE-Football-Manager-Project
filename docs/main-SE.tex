...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{images/Live score1.png}
    \caption{Live Score example created by Justin}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{images/Test coverage.png}
