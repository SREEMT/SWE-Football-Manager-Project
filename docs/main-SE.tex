...
\subsection{Diagrams}
Modelling: Your team must create a Sequence Diagram that presents one of the scenarios for Live Scoring or Live Matches in your software. This diagram must be added to your documentation on the Diagrams subsection (inside the System Design section).
...
\hline
1 & 10/14 - 10/23 & U7 Homepage screen, U3 Login/sign-up screen, U13 My Account screen, U2 Inbox screen & 10 \\ \hline
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{images/Screenshot 2025-11-09 224237.png}
    \caption{Test coverage from Alberto's end}
\end{figure}
